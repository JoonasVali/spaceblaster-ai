...
public class ElevenLabsOxleySoundDurationEvaluator implements SoundDurationEvaluator {

  public static final int COLON_PENALTY = 15;
  public static final int PUNCTUATION_PENALTY = 7;
  public static final long PER_CHARACTER_TIME = 55L;
