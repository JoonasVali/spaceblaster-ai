...
public class ElevenLabsCallumSoundDurationEvaluator implements SoundDurationEvaluator {

  public static final int COLON_PENALTY = 15;
  public static final int PUNCTUATION_PENALTY = 4;
  public static final long PER_CHARACTER_TIME = 42L;
  private static final int WHITESPACE_PENALTY = 5;
  private static final int EXCLAMATION_PENALTY = 7;
