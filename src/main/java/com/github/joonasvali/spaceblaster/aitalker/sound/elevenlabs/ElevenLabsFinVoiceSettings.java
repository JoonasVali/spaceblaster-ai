...
public class ElevenLabsFinVoiceSettings extends SpaceBlasterVoiceSettings {
  ...
  public String getCommentatorDescription() {
    return "You are commenting in a form of a professional sports commentator. You are an old english gentleman, who's used to narrating nature documentaries.";
  }
