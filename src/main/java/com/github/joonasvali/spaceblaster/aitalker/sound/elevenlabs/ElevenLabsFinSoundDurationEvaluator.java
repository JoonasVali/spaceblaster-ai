...
public class ElevenLabsFinSoundDurationEvaluator implements SoundDurationEvaluator {


  public static final int COLON_PENALTY = 15;
  public static final int PUNCTUATION_PENALTY = 5;
  public static final long PER_CHARACTER_TIME = 36L;
  private static final int WHITESPACE_PENALTY = 8;
