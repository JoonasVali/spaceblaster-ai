...
public class ElevenLabsProtossSoundDurationEvaluator implements SoundDurationEvaluator {

  public static final int COLON_PENALTY = 15;
  public static final int PUNCTUATION_PENALTY = 12;
  public static final long PER_CHARACTER_TIME = 44L;
  private static final int WHITESPACE_PENALTY = 5;
  private static final int EXCLAMATION_PENALTY = 10;
