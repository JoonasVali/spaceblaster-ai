...
public class ElevenLabsBlondieSoundDurationEvaluator implements SoundDurationEvaluator {

  public static final int COLON_PENALTY = 14;
  public static final int PUNCTUATION_PENALTY = 3;
  public static final long PER_CHARACTER_TIME = 45L;
  private static final int WHITESPACE_PENALTY = 6;
  private static final int EXCLAMATION_PENALTY = 9;
